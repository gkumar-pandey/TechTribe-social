export const PostsShimmerLoader = () => {
  return (
    <>
      <div className=" border rounded-md shadow-lg max-w-[40rem] w-full m-auto my-2  bg-white p-4 ">
...
export const ShimmerProfileTile = () => {
  return (
    <>
      <div className=" flex items-center justify-between w-full my-2  gap-4 p-2 border rounded-md  ">
